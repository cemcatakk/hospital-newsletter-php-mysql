...
--
-- Anamakine: localhost
-- Üretim Zamanı: 12 Oca 2021, 14:01:49
...
--
CREATE DATABASE IF NOT EXISTS `vthastane` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `vthastane`;
...
(1, 'test', 'test', 'test', 1, 1, 'test'),
(3, 'asd', 'asd', 'asd', 2, 1, 'asd');
...
(9, 'test', 'test', 'test', 'test', 'test', 1, 1, 'A+', 'test', 0, 0),
(10, 'test2', 'test2', 'test2', 'test2', 'test2', 1, 1, 'A+', 'tet2', 0, 0);
...
INSERT INTO `mesajlar` (`id`, `mesaj`, `gonderilmezamani`) VALUES
(1, 'test', '2021-01-09');
